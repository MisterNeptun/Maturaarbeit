...
class Spieler_1():
    def __init__(self,wert1,wert2):
        ...
        self.posy = 860
        self.gekauft = []
        # noch pro farbe ein element das überprüft ob man die ganze Farbreihe fürs bauen hat
        self.bahnen = []
        self.werke = []
        self.eins = []
        self.zwei = []
    ...
    def kaufen(self, nochnichtgekauft, verkaufteimoblien):
        for i in range(len(nochnichtgekauft)):
            if self.position == nochnichtgekauft[i].position and self.geld - nochnichtgekauft[i].startwert > 0 and self.geld-nochnichtgekauft[i].startwert>self.geld*(self.wert1-0.2) and self.geld>self.wert2*10000:
